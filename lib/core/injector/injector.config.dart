...
_i1.GetIt $initGetIt(_i1.GetIt get, {String? environment, _i2.EnvironmentFilter? environmentFilter}) {
  ...
  gh.factoryAsync<_i17.UserLocalDataSource>(
      () async => _i18.UserLocalDataSourceImpl(get<_i5.FirebaseAuth>(), await get.getAsync<_i16.SharedPreferences>()));
  gh.factoryAsync<_i19.UserRepository>(
      () async => _i20.UserRepositoryImpl(await get.getAsync<_i17.UserLocalDataSource>()));
