...
import 'package:looping_diary/core/services/analytics/crash_reporting_service.dart' as _i9;
import 'package:looping_diary/core/services/navigation/navigation_service.dart' as _i3;
import 'package:looping_diary/core/services/registration_service.dart' as _i10; // ignore_for_file: unnecessary_lambdas
...
_i1.GetIt $initGetIt(_i1.GetIt get, {String? environment, _i2.EnvironmentFilter? environmentFilter}) {
  ...
  gh.factory<_i9.CrashReportingService>(() => _i9.CrashReportingService(get<_i5.FirebaseCrashlytics>()));
  return get;
}
