...
import 'package:looping_diary/core/services/navigation/navigation_service.dart'
    as _i3;
import 'package:looping_diary/core/services/registration_service.dart' as _i13;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i10.SaveNoteUseCase>(
      () => _i10.SaveNoteUseCase(get<_i11.NotesRepository>()));
  gh.factory<_i12.CrashReportingService>(
      () => _i12.CrashReportingService(get<_i6.FirebaseCrashlytics>()));
  return get;
}
