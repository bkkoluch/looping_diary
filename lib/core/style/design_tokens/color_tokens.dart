...
class ColorTokens {
  ...
  static const Color teal = Color(0xFF57E2E5);
  static const Color pink = Color(0xFFF8A4D8);
  static const Color beige = Color(0xFFFEFAE0);
  static const Color white = Color(0xFFFFFFFF);
  static const Color lightGrey = Color(0xFFDADFEA);
...
List<Color> bookmarkColors = [
  ...
  ColorTokens.lightGrey,
  ColorTokens.pink,
  ColorTokens.brandSecondary,
  ColorTokens.brownDarker,
  ColorTokens.scarletRed,
  ColorTokens.white,
];
