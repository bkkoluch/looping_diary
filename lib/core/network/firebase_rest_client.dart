...
class FirebaseRestClient {
  ...
  Future patchWithQueryParameters(String uri, String json, Map<String, dynamic> queryParameters) =>
      http.patch(Uri.parse('$_baseUrl$_userId$uri').replace(queryParameters: queryParameters), body: json);
