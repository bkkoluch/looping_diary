...
class _$_NoteState extends _NoteState {
  const _$_NoteState({required final List<Note> allNotes, required this.currentNote, required this.status})
      : _allNotes = allNotes,
        super._();
  ...
  @override
  int get hashCode => Object.hash(runtimeType, const DeepCollectionEquality().hash(_allNotes),
